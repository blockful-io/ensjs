...
import type { DecodedAddr, Prettify, SimpleTransactionRequest } from '../../types';
...
declare const _getAddr: import("../../utils/generateFunction").GeneratedFunction<(_client: ClientWithEns, { name, coin, bypassFormat }: Omit<InternalGetAddrParameters, 'strict'>) => SimpleTransactionRequest, (_client: ClientWithEns, data: Hex, { coin, strict }: Pick<InternalGetAddrParameters, 'coin' | 'strict'>) => Promise<InternalGetAddrReturnType>>;
