...
declare const universalWrapper: import("../../utils/generateFunction").GeneratedFunction<(client: ClientWithEns, { name, data, gatewayUrls }: Omit<UniversalWrapperParameters, 'strict'>) => TransactionRequestWithPassthrough, (_client: ClientWithEns, data: Hex | BaseError, passthrough: GenericPassthrough, { strict, gatewayUrls, }: Pick<UniversalWrapperParameters, 'strict' | 'gatewayUrls'>) => Promise<UniversalWrapperReturnType>>;
