...
const ccipBatchRequest_1 = require("./ccipBatchRequest");
...
const ccipRequest = (chain) => async ({ data, sender, urls, }) => {
    const universalResolverAddress = (0, getChainContractAddress_1.getChainContractAddress)({
        client: { chain },
    ...
    if (isUniversalResolverRequest &&
        ...
        const result = await (0, ccipBatchRequest_1.ccipBatchRequest)(args[0]);
